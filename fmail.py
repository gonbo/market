"""
    Email implement for sending email.
...
class Mail(object):
    ...
    def from_object(self, obj):
        """Initializes your mail settings from the given object.
        ...
        self.debug = int(config.get('MAIL_DEBUG', False))
        self.max_emails = config.get('DEFAULT_MAX_EMAILS')
        self.suppress = config.get('MAIL_SUPPRESS_SEND', False)
        self.fail_silently = config.get('MAIL_FAIL_SILENTLY', False)
